...
<header id="header">
   ...
   <div id="body">
      <div class="content-container">
         <main id="main"> <img src="${path}/images/bg-main-4.png"
            alt="image" />
         <h1></h1>
         ...
         <aside id="aside">
            ...
            <nav id="testNav">
               <div class="thumbs">
                  ...
                  <ul>
                     <li><a href="${path}/images/bg-main-4.png"><img
                           src="${path}/images/bg-main-4.png"></a></li>

                     <li><a href="${path}/images/bg-main-1.png"><img
                           src="${path}/images/bg-main-1.png"></a></li>

                     <li><a href="${path}/images/bg-main-2.png"><img
                           src="${path}/images/bg-main-2.png"></a></li>

                     <li><a href="${path}/images/bg-main-3.png"><img
                           src="${path}/images/bg-main-3.png"></a></li>
                  </ul>
               </div>
            </nav>
         </aside>
